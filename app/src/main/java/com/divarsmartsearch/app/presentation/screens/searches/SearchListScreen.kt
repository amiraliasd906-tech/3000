...
fun SearchListScreen(
    ...
    AuroraScreenBackground {
        Scaffold(
            ...
            topBar = { TopAppBar(title = { Text("جستجوهای من") }, colors = transparentTopBarColors()) }
        ) { padding ->
        when {
...
private fun SearchRow(
    ...
    Card(
        ...
        modifier = if (search.status == SearchStatus.ACTIVE) {
            // A running search gets a soft glow so the currently-active
            // searches visually stand apart from paused ones at a glance,
            // instead of every row looking identical regardless of state.
            Modifier.glowBorder(
